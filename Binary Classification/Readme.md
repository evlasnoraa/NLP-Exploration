...
**N_estimators**: the number of trees created in our forest, **max_depth**: The maximum allowed depth of our tree, **min_samples_split**: Minimum number of samples required before splitting, **min_samples_leaf**: Minimum number of samples required in leaf nodes, **max_features**: Maximum number of features considered for splitting data, **ngram_max**: ngrams to be considered for feature generation. 
